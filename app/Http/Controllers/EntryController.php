...
class EntryController extends Controller
{
    ...
    {
        // store all entries in cache for one hour (3600 seconds)
    ...
    {
        // store moods in cache for one hour (3600 seconds)
    ...
    {
        // Date must be in Y-M-D format. Must also not already exist in entries table date column
